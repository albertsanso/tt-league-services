...
- Player name (Optional)
  The filter controls follow the layout in `../../../frontend/match-search-filters-mockup-spec.md`: source, season, competition, and date range share the first row; player location uses Home/Away radio controls; and player name appears below.
...
Expand `../../../frontend/club-detail-view-mockup-spec.md` into an implementation sub-plan inside `FEAT-00004-DETAILS.md`, then use that sub-plan to implement the application
...
Expand `../../../frontend/theme-spec.md` into an implementation sub-plan inside
...
- [x] `FEAT-00001-DETAILS.md` contains an explicit sub-plan covering the sections and implementation requirements of `../../../frontend/theme-spec.md`.
- [x] The application follows the theme specifications defined in `../../../frontend/theme-spec.md` and the expanded sub-plan.
