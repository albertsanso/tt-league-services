...
public interface ClubSeasonRepositoryHelper extends JpaRepository<ClubSeasonJPA, UUID> {
    ...
    Optional<ClubSeasonJPA> findClubSeasonByNameAndSeasonAndSource(String name, String season, String source);

    List<ClubSeasonJPA> findByClub_IdAndSeason(UUID clubId, String season);
