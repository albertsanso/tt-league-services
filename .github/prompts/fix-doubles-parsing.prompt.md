...
Apply the JSON model definition in file `docs/model-definition.json` to doubles matches in the codebase.
...
This prompt ensures that doubles matches in the codebase adhere to the JSON model definition specified in `docs/model-definition.json`.
