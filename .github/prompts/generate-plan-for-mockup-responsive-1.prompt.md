---
name: Generate plan for mockup 1
---
...
Generate a detailed plan based on `../../docs/mockups-prompts/mockup-responsive-1.prompt.md` into the file `docs/mockups-plans/mockup-responsive-1.plan.md`.
