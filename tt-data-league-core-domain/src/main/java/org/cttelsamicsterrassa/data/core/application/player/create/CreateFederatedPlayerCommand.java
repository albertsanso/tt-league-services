...
public class CreateFederatedPlayerCommand extends DomainCommand {
    private final UUID federatedPlayerId;
    private final String federatedPlayerName;
    private final ImportSource source;

    public CreateFederatedPlayerCommand(ZonedDateTime occurredOn, String commandId, UUID federatedPlayerId, String federatedPlayerName, ImportSource source) {
        super(occurredOn, commandId);
        this.federatedPlayerId = federatedPlayerId;
        this.federatedPlayerName = federatedPlayerName;
        this.source = source;
    }
    public UUID getFederatedPlayerId() { return federatedPlayerId; }
    public String getFederatedPlayerName() { return federatedPlayerName; }
