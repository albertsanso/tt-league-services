...
const es = {
  ...
  routes: { ...ca.routes, general: 'General', clubSearch: 'Buscar clubes', playerSearch: 'Buscar jugadores', clubDetail: 'Detalle del club', clubEdit: 'Editar club', competitionDetail: 'Detalle de competición', playerDetail: 'Detalle del jugador', matchSearch: 'Buscar partidos', searchResults: 'Resultados de búsqueda', settings: 'Configuración', administration: 'Administración', administrationUsers: 'Usuarios y roles', administrationSettings: 'Configuración del sistema', administrationImport: 'Importación de datos', administrationClubs: 'Consolidación de clubes' },
