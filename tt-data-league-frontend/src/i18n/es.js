...
const es = {
  ...
  routes: { ...ca.routes, general: 'General', clubSearch: 'Buscar clubes', playerSearch: 'Buscar jugadores', clubDetail: 'Detalle del club', clubEdit: 'Editar club', competitionDetail: 'Detalle de competición', playerDetail: 'Detalle del jugador', matchSearch: 'Buscar partidos', matchActa: 'Acta del partido', matchSummary: 'Resumen del partido', searchResults: 'Resultados de búsqueda', settings: 'Configuración', administration: 'Administración', administrationUsers: 'Usuarios y roles', administrationSettings: 'Configuración del sistema', administrationImport: 'Importación de datos', administrationClubs: 'Consolidación de clubes' },
  ...
  matchSummaryPage: {
    ...
    loadErrorDescription: 'Ha habido un problema al consultar esta información.',
    ...
    trend: {
      ...
      stable: 'Estable respecto a los anteriores ({{previous}}% → {{current}}%)',
    },
    lineup: 'Alineación',
    lineupEmpty: 'No hay alineación disponible.',
    letter: 'Posición',
    ranking: 'Ranking',
    playerForm: 'Forma reciente',
    alignmentStability: 'Estabilidad de la alineación',
    alignmentBadge: { regular: 'Alineación habitual', rare: 'Poco habitual', new: 'Combinación nueva' },
    ...
    comparison: {
      ...
      inline: 'En línea con la media de victorias del equipo ({{winRate}})',
    },
  },
  ...
  detail: { ...ca.detail, viewMatch: 'Ver el partido', identityClub: 'Identidad del club', identityCanonical: 'Identidad canónica', editClub: 'Editar el club', clubNotFound: 'Club no encontrado', clubNotFoundDescription: 'El club solicitado no existe o el identificador no es válido.', clubLoadError: 'No se ha podido cargar el club', clubLoadDescription: 'Ha habido un problema al consultar esta información.', backSearch: 'Volver a la búsqueda', loadingClub: 'Cargando el club...', editDescription: 'Actualiza el nombre visible del club.', nameValidation: 'El nombre del club necesita al menos 2 caracteres.', permissionEdit: 'No tienes permisos para editar este club.', updateError: 'No se ha podido actualizar el club. Inténtalo de nuevo.', save: 'Guardar cambios', saving: 'Guardando...', updated: 'El nombre del club se ha actualizado correctamente.', clubViews: 'Vistas del club', allSources: 'Todas las fuentes', allSeasons: 'Todas las temporadas', noSeasons: 'Sin temporadas', allCompetitions: 'Todas las competiciones', federatedRecords: 'Registros federados: {{records}}', registeredPlayersEmpty: 'No hay jugadores registrados para los filtros seleccionados.', clubPlayers: 'Jugadores del club', competitionsEmpty: 'No hay resúmenes de competición disponibles para los filtros seleccionados.', clubCompetitions: 'Competiciones del club', matchesAvailable: '{{count}} partidos disponibles', clubMatchesEmpty: 'No hay partidos disponibles para los filtros seleccionados.', clubMatchesLoadError: 'No se han podido cargar los partidos del club.', unknownTeam: 'Equipo desconocido', viewCompetition: 'Ver la competición', competitionNotFound: 'Competición no encontrada', competitionNotFoundDescription: 'No se ha encontrado la competición solicitada para esta temporada.', competitionLoadError: 'No se ha podido cargar la competición', matchesQueryError: 'Ha habido un problema al consultar los partidos.', backClub: 'Volver al club', loadingCompetition: 'Cargando la competición...', competitionMatchesLabel: 'Partidos de la competición', competitionEmpty: 'No hay partidos disponibles para esta competición.', pendingResult: 'Resultado pendiente', win: 'Victoria', loss: 'Derrota', draw: 'Empate', round: 'Jornada {{round}}', playerNotFound: 'Jugador no encontrado', playerNotFoundDescription: 'El jugador solicitado no existe o el identificador no es válido.', playerLoadError: 'No se ha podido cargar el jugador', sessionExpiredDetails: 'La sesión ha caducado. Vuelve a iniciar sesión para continuar.', updatingPlayer: 'Actualizando los datos del jugador...', uuid: 'UUID: {{id}}', selectSeason: 'Selecciona la temporada', playerViews: 'Vistas del jugador', opponentAnalysis: 'Análisis de oponentes', opponentFilterGroupLabel: 'Filtrar oponentes por categoría', opponentFilterAll: 'Todos', opponentFilterAriaLabel: '{{label}}, {{count}} oponentes', opponentListSummary: '{{count}} oponentes.', statisticsHistory: 'Historial estadístico', statisticsEmpty: 'No hay datos estadísticos disponibles para los filtros seleccionados.', chartLegend: 'Leyenda del gráfico', historyValues: 'Valores del historial estadístico', opponentResults: 'Resultados por oponente', opponentsEmpty: 'Ningún oponente coincide con los filtros.', opponentSearch: 'Buscar un oponente', showMore: 'Mostrar {{count}} oponentes más', categoryFavorableLabel: 'Favorable', categoryHardLabel: 'Difícil', categoryProblemLabel: 'Problemático', categoryUnknown: 'Sin categoría', unavailableOpponent: 'Oponente no disponible', unavailableDate: 'Fecha no disponible', unavailableScore: 'Marcador no disponible', unavailableDetails: 'Detalle de oponentes no disponible.', game: 'Juego {{number}}', doubles: 'Dobles', singles: 'Individual', opponents: 'Oponentes', unavailablePlural: 'No disponibles', resultTeams: 'Resultado:', teams: 'Equipos:', opponentSortCloseness: 'Proximidad', insightsTitle: 'Información del oponente', insightCloseness: 'Proximidad', insightClosenessHint: 'Margen medio de sets por enfrentamiento: indica si el partido suele ser una goleada o se decide muy ajustado.', insightClosenessDecisive: 'Decisivo', insightClosenessCompetitive: 'Competitivo', insightClosenessNailBiter: 'Muy ajustado', insightAverageMargin: 'margen medio ±{{value}}', insightSingles: 'Individual', insightSinglesHint: 'Porcentaje de victorias solo en partidos individuales contra este oponente.', insightDoubles: 'Dobles', insightDoublesHint: 'Porcentaje de victorias solo en partidos de dobles contra este oponente — muestra si el punto débil es el juego de dobles.', insightHomeAway: 'Local / Visitante', insightHomeAwayHint: 'Porcentaje de victorias jugando en casa y fuera contra este oponente, para detectar una rivalidad sensible a la pista.', insightHomeShort: 'L', insightAwayShort: 'V', insightStreaks: 'Rachas', insightStreaksHint: 'La racha de victorias y de derrotas más larga conseguida contra este oponente, no solo la racha actual.', insightWinShort: 'V', insightLossShort: 'D', insightStreakBest: 'mejor', insightStreakWorst: 'peor', insightLastMet: 'Último enfrentamiento', insightLastMetHint: 'Cuánto hace del último enfrentamiento y con qué frecuencia jugáis, para distinguir un rival habitual de un encuentro puntual.', insightFrequencyPerSeason: '{{count}} partidos/temporada', insightTrend: 'Tendencia', insightTrendHint: 'Compara el porcentaje de victorias de los partidos más recientes con los anteriores contra este oponente: indica si mejoras o empeoras frente a él.', insightTrendImproved: 'Mejora ({{previous}}% → {{current}}%)', insightTrendDeclining: 'Empeora ({{previous}}% → {{current}}%)', insightTrendStable: 'Estable ({{previous}}% → {{current}}%)', insightCompetitionBreakdown: 'Por competición', insightCompetitionBreakdownHint: 'Resultados separados por competición, cuando habéis coincidido en más de una: el rendimiento puede variar según dónde se juega.', careerSummary: 'Resumen de carrera', currentStreakLabel: 'Racha actual', longestWinStreak: 'Racha de victorias más larga', singlesWinPercentage: 'Porcentaje de victorias (individual)', doublesWinPercentage: 'Porcentaje de victorias (dobles)', averageSetMargin: 'Margen medio de sets', averageScore: 'Puntuación media', matchOrder: 'Orden de los partidos', spectrumChartAria: 'Espectro de resultados: calidad de cada partido jugado, desde derrota contundente hasta victoria contundente, en orden cronológico.' },
...
es.detail.playersSearchPlaceholder = 'Nombre del jugador'
es.detail.playersShownCount = '{{shown}} de {{total}} jugadores'
es.detail.playersSearchEmpty = 'Ningún jugador coincide con «{{query}}».'
es.detail.playersSourcesCount = '{{count}} federaciones'
es.detail.playersByCompetitionTitle = 'Jugadores por competición'
es.detail.playersMostRepresented = '{{count}} jugadores'
es.detail.playersMostActiveTitle = 'Más activos (histórico)'
es.detail.playersMostActiveSub = '{{seasons}} temporadas'
es.detail.playersLatestSeason = 'Temporada más reciente'
es.detail.matchesHomeAwayTile = 'Local / Visitante'
es.detail.matchesPending = 'Pendientes'
es.detail.matchesFormGuide = 'Forma'
es.detail.matchesCurrentStreak = 'racha actual: {{count}} {{result}}'
es.detail.matchesNotableTitle = 'Partidos destacados'
es.detail.matchesClosest = 'Resultado más ajustado'
es.detail.matchesBiggestWin = 'Victoria más amplia'
es.detail.matchesBiggestLoss = 'Derrota más amplia'
