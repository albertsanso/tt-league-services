...
const es = {
  ...
  systemSettings: { ...ca.systemSettings, title: 'Configuración del sistema', description: 'Ajustes seguros para la interfaz, notificaciones, importaciones y visualización.', search: 'Buscar', category: 'Categoría', download: 'Descargar copia', restore: 'Restaurar copia', loading: 'Cargando configuración...', empty: 'No hay ajustes para estos filtros.', unauthorized: 'La sesión ha caducado.', forbidden: 'No tienes permisos para gestionar la configuración.', conflict: 'La configuración ha cambiado. Recarga antes de guardar.', serverError: 'No se ha podido cargar la configuración.', preview: 'Previsualizar', previewSuccess: 'Los valores son válidos. No se ha guardado ningún cambio.', apply: 'Aplicar cambios', saved: 'Configuración guardada.', restored: 'Copia restaurada correctamente.', restoreConfirm: 'La restauración sustituirá toda la configuración. ¿Continuar?', fileTooLarge: 'Las copias no pueden superar 1 MiB.', categories: { ALL: 'Todas', UI: 'Interfaz', NOTIFICATIONS: 'Notificaciones', IMPORT: 'Importación', DISPLAY: 'Visualización' }, labels: { 'ui.theme': 'Tema', 'ui.compactMode': 'Modo compacto', 'notifications.emailEnabled': 'Notificaciones por correo', 'notifications.inAppEnabled': 'Notificaciones en la aplicación', 'notifications.importCompleted': 'Avisos de finalización de importación', 'import.autoValidate': 'Validar importaciones automáticamente', 'import.preserveHistory': 'Conservar historial de importación', 'import.maxBatchSize': 'Lote máximo de importación', 'display.maxSearchResults': 'Máximo de resultados de búsqueda', 'display.maxPageSize': 'Tamaño máximo de página' } },
